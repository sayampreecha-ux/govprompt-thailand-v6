(() => {
  ...
  function evaluate(input = {}) {
    if (input.precedentReliedOn !== true) {
      return Object.freeze({ pass: true, status: 'NOT_APPLICABLE', decisionLock: false, blockers: [] });
    }
    ...
    return Object.freeze({
      ...
      requirements: Object.freeze([
        'identify-precedent-fact-date-not-judgment-date',
        'identify-current-fact-date',
        'search-intervening-and-current-authorities',
        'verify-event-time-and-current-rule-versions',
        'resolve-effect-of-each-relevant-later-authority',
        'perform-contrary-evidence-check'
      ])
    });
  }
